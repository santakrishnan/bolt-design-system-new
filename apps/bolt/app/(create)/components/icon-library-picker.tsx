    ...
    <div className="group/picker relative">
      <Picker>
        <PickerTrigger>
          ...
          <div className="pointer-events-none absolute top-1/2 right-4 flex size-4 -translate-y-1/2 select-none items-center justify-center text-base text-foreground *:[svg]:text-foreground!">
