...
export function Preview() {
  ...
  return (
    <div className="relative -mx-1 flex flex-1 flex-col justify-center sm:mx-0">
      <div className="relative -z-0 mx-auto flex 3xl:max-h-[1200px] w-full 3xl:max-w-[1800px] flex-1 flex-col overflow-hidden rounded-2xl ring-1 ring-foreground/15">
