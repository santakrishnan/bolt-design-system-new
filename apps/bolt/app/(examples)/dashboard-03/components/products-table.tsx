  ...
  return (
    <Card className="flex w-full flex-col gap-4">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <div className="@3xl/page:flex hidden items-center gap-2 **:data-[slot=button]:size-8 **:data-[slot=select-trigger]:h-8">
      ...
      <CardFooter className="flex @3xl/page:flex-row flex-col items-center justify-between border-t pt-6">
        <div className="@3xl/page:block hidden text-muted-foreground text-sm">
