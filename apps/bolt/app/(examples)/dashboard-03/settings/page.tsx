  ...
  return (
    <div className="@container/page flex flex-1 flex-col gap-8 p-6">
      <Tabs className="gap-6" defaultValue="account">
        ...
        <TabsContent
          className="grid @3xl/page:grid-cols-2 gap-6"
          value="security"
        >
...
function FieldGroup({ children }: React.ComponentProps<"div">) {
  return (
    <div
      className="@container/field-group flex min-w-0 max-w-4xl flex-col @3xl:gap-6 gap-8"
...
function Field({ children, className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "grid auto-rows-min @3xl/field-group:grid-cols-2 items-start @3xl/field-group:gap-6 gap-3 *:data-[slot=label]:col-start-1 *:data-[slot=label]:row-start-1",
        className
      )}
      data-slot="field"
      {...props}
...
function FieldDescription({
  ...
  return (
    <p
      className={cn(
        "@3xl/field-group:col-start-1 @3xl/field-group:row-start-1 @3xl/field-group:translate-y-6 text-muted-foreground text-sm",
        className
      )}
