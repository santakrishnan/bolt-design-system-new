...
// Base UI tooltip has a module resolution issue with Next.js 16
// Error occurs with AND without Turbopack - it's a Next.js 16 + Base UI 1.1.0 compatibility issue
// Temporarily disabled - using only Radix tooltips which work perfectly
