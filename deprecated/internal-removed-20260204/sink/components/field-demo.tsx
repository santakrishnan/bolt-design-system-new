...
export function FieldDemo() {
  return (
    <div className="@container w-full">
      <div className="grid @3xl:grid-cols-2 @5xl:grid-cols-3 @[120rem]:grid-cols-4 @[140rem]:grid-cols-5 gap-4 bg-muted p-4">
          ...
          <FieldGroup>
            ...
            <RadioGroup>
              <Field orientation="horizontal">
                ...
                <RadioGroupItem id="dark-mode-22-f3j" value="dark-mode-22" />
              </Field>
            </RadioGroup>
            <FieldSeparator />
            <Field orientation="horizontal">
            ...
            <FieldSet>
              ...
              <RadioGroup>
                <Field orientation="horizontal">
                  <RadioGroupItem id="battery-level-high-k6p" value="high" />
                ...
                <Field orientation="horizontal">
                  <RadioGroupItem id="battery-level-low-v1c" value="low" />
              ...
              <RadioGroup>
                <FieldLabel htmlFor="metric-l6m">
                  <Field orientation="horizontal">
                    ...
                    <RadioGroupItem id="metric-l6m" value="metric" />
                  </Field>
                </FieldLabel>
                <FieldLabel>
                  <Field orientation="horizontal">
                    <RadioGroupItem id="imperial-x8j" value="imperial" />
            ...
            <RadioGroup defaultValue="plus">
              <FieldLabel htmlFor="plus-g4s">
                <Field orientation="horizontal">
                  ...
                  <RadioGroupItem id="plus-g4s" value="plus" />
                </Field>
              </FieldLabel>
              <FieldLabel htmlFor="pro-m9d">
                <Field orientation="horizontal">
                  ...
                  <RadioGroupItem id="pro-m9d" value="pro" />
                </Field>
              </FieldLabel>
              <FieldLabel htmlFor="enterprise-k7w">
                <Field orientation="horizontal">
                  ...
                  <RadioGroupItem id="enterprise-k7w" value="enterprise" />
                </Field>
              </FieldLabel>
              <FieldLabel htmlFor="custom-plan-r3t">
                <Field orientation="horizontal">
                  ...
                  <RadioGroupItem id="custom-plan-r3t" value="custom-plan" />
                </Field>
              </FieldLabel>
            </RadioGroup>
          </FieldSet>
            ...
            <FieldLabel htmlFor="everyone-f8k">
              <Field orientation="horizontal">
                ...
                <RadioGroupItem
                  ...
                  value="everyone"
                />
                <IconCircle className="size-5 stroke-1 stroke-input group-has-data-[state=checked]/field:hidden" />
        ...
        <CardContent>
          <RadioGroup>
            <FieldLabel htmlFor="everyone-b9p">
              <Field orientation="horizontal">
                <RadioGroupItem id="everyone-b9p" value="everyone" />
                <FieldContent>
            ...
            <FieldLabel htmlFor="followers-v3n">
              <Field orientation="horizontal">
                <RadioGroupItem id="followers-v3n" value="followers" />
                <FieldContent>
                  <FieldTitle>Followers</FieldTitle>
                  <FieldDescription>
                    Visible to your followers and connections.
            ...
            <FieldLabel htmlFor="custom-t8v">
              <Field orientation="horizontal">
                <RadioGroupItem id="custom-t8v" value="custom" />
                <FieldContent>
                  <FieldTitle>Custom</FieldTitle>
                  <FieldDescription>
                    Choose who can see your profile.
        ...
        <form>
          <FieldGroup>
            <FieldSet>
              ...
              <FieldGroup className="flex flex-row flex-wrap gap-2 [--radius:9999rem] *:data-[slot=field-label]:w-fit **:data-[slot=field]:gap-2 **:data-[slot=field]:overflow-hidden **:data-[slot=checkbox]:rounded-full **:data-[slot=field]:px-2.5 **:data-[slot=field]:py-2">
            ...
            <FieldSet>
              ...
              <RadioGroup defaultValue="h100">
                <FieldLabel htmlFor="h100-k9s">
                  <Field orientation="horizontal">
                    <RadioGroupItem id="h100-k9s" value="h100" />
                    <FieldContent>
                ...
                <FieldLabel htmlFor="h200-m3v">
                  <Field orientation="horizontal">
                    <RadioGroupItem id="h200-m3v" value="h200" />
                    <FieldContent>
            ...
            <FieldSet>
              ...
              <RadioGroup defaultValue="today">
                <FieldLabel htmlFor="today-n7t">
                  <Field orientation="horizontal">
                    <RadioGroupItem id="today-n7t" value="today" />
                    <FieldContent>
                ...
                <FieldLabel htmlFor="scheduled-u5j">
                  <Field orientation="horizontal">
                    <RadioGroupItem id="scheduled-u5j" value="scheduled" />
                    <FieldContent>
            ...
            <Field>
              ...
              <ButtonGroup>
                ...
                <Select defaultValue="hours">
                  <SelectTrigger className="w-24" id="duration-b9p">
          ...
          <FieldSet>
            ...
            <RadioGroup>
              <FieldLabel htmlFor="pickup-x8m">
                <Field orientation="horizontal">
                  <RadioGroupItem id="pickup-x8m" value="pickup" />
                  <FieldContent>
                    <FieldTitle>
              ...
              <FieldLabel htmlFor="delivery-v3s">
                <Field orientation="horizontal">
                  <RadioGroupItem id="delivery-v3s" value="delivery" />
                  <FieldContent>
              ...
              <FieldLabel htmlFor="express-l7r">
                <Field orientation="horizontal">
                  <RadioGroupItem id="express-l7r" value="express" />
                  <FieldContent>
          ...
          <FieldSet>
            ...
            <RadioGroup defaultValue="h100">
              <FieldLabel htmlFor="h100-v00">
                <Field orientation="horizontal">
                  <RadioGroupItem id="h100-v00" value="h100" />
                  <FieldContent>
                    <FieldTitle>NVIDIA H100</FieldTitle>
                    <FieldDescription>SXM5 80GB VRAM</FieldDescription>
                  </FieldContent>
              ...
              <FieldLabel htmlFor="h200-n86">
                <Field orientation="horizontal">
                  <RadioGroupItem id="h200-n86" value="h200" />
                  <FieldContent>
                    <FieldTitle>NVIDIA H200</FieldTitle>
                    <FieldDescription>SXM5 141GB VRAM</FieldDescription>
                  </FieldContent>
          ...
          <FieldSet>
            ...
            <RadioGroup defaultValue="kubernetes">
              <FieldLabel htmlFor="kubernetes-dtv">
                <Field orientation="horizontal">
                  <RadioGroupItem id="kubernetes-dtv" value="kubernetes" />
                  <FieldContent>
                    <FieldTitle>Kubernetes</FieldTitle>
                    <FieldDescription>
                      Run GPU workloads on a K8s configured cluster.
              ...
              <FieldLabel htmlFor="vm-8rk">
                <Field orientation="horizontal">
                  <RadioGroupItem id="vm-8rk" value="vm" />
                  <FieldContent>
                    <FieldTitle>Virtual Machine</FieldTitle>
                    <FieldDescription>
                      Access a VM configured cluster via SSH to run GPU
          ...
          <FieldSet>
            ...
            <RadioGroup defaultValue="today">
              <FieldLabel htmlFor="today-pmd">
                <Field orientation="horizontal">
                  <RadioGroupItem id="today-pmd" value="today" />
                  <FieldContent>
                    <FieldTitle>Start cluster now</FieldTitle>
                    <FieldDescription>
                      Your cluster will be ready to use immediately.
              ...
              <FieldLabel htmlFor="scheduled-tc9">
                <Field orientation="horizontal">
                  <RadioGroupItem id="scheduled-tc9" value="scheduled" />
                  <FieldContent>
                    <FieldTitle>Schedule a start date and time</FieldTitle>
                    <FieldDescription>
                      Set a start date and time for your cluster.
        ...
        <form>
          <FieldGroup>
            ...
            <Field>
              ...
              <Input id="signup-password-rh7" required type="password" />
              <FieldDescription>
        ...
        <form>
          <FieldGroup>
            ...
            <Field>
              ...
              <Input id="login-7x9-password-5l8" required type="password" />
              <FieldDescription>
      ...
      <CardContent>
        <form>
          <FieldGroup>
            ...
            <Field orientation="horizontal">
              <Checkbox defaultChecked id="finder-pref-9k2-open-tabs-uui" />
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              <RadioGroup defaultValue="general">
                <Field orientation="horizontal">
                  <RadioGroupItem id="feedback-8m4-bug" value="bug" />
                  <FieldLabel
                    className="font-normal"
          ...
          <FieldGroup>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field>
                ...
                <Input id="payment-9n3-cvv" maxLength={4} placeholder="123" />
        ...
        <FieldGroup>
          <FieldSet>
            ...
            <RadioGroup defaultValue="free">
              <Field orientation="horizontal">
                <RadioGroupItem id="free-ejb" value="free" />
                <FieldLabel className="font-normal" htmlFor="free-ejb">
                  Free Plan
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <RadioGroupItem id="pro-y3g" value="pro" />
                <FieldLabel className="font-normal" htmlFor="pro-y3g">
                  Pro Plan
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <RadioGroupItem id="enterprise-l4t" value="enterprise" />
                <FieldLabel className="font-normal" htmlFor="enterprise-l4t">
                  Enterprise
                </FieldLabel>
              </Field>
            </RadioGroup>
          ...
          <FieldSet>
            ...
            >
              <Field orientation="horizontal">
                <RadioGroupItem id="size-small-1g9" value="small" />
                <FieldLabel className="font-normal" htmlFor="size-small-1g9">
                  Small
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <RadioGroupItem id="size-medium-okp" value="medium" />
                <FieldLabel className="font-normal" htmlFor="size-medium-okp">
                  Medium
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <RadioGroupItem id="size-large-tzy" value="large" />
                <FieldLabel className="font-normal" htmlFor="size-large-tzy">
                  Large
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <RadioGroupItem id="size-xlarge-2nn" value="xlarge" />
                <FieldLabel className="font-normal" htmlFor="size-xlarge-2nn">
                  X-Large
                </FieldLabel>
              </Field>
            </RadioGroup>
          ...
          <FieldSet>
            ...
            <RadioGroup defaultValue="email">
              <Field orientation="horizontal">
                <RadioGroupItem id="notify-email-enh" value="email" />
                <FieldLabel className="font-normal" htmlFor="notify-email-enh">
                  Email only
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
              ...
              <Field orientation="horizontal">
                <RadioGroupItem id="notify-both-0ed" value="both" />
                <FieldLabel className="font-normal" htmlFor="notify-both-0ed">
                  Both Email & SMS
                </FieldLabel>
              </Field>
            </RadioGroup>
          ...
          <FieldSet>
            ...
            >
              <Field orientation="horizontal">
                <RadioGroupItem id="delivery-express-n5l" value="express" />
                <FieldContent>
                  <FieldLabel
                    className="font-normal"
              ...
              <Field orientation="horizontal">
                <RadioGroupItem id="delivery-standard-14i" value="standard" />
                <FieldContent>
                  <FieldLabel
                    className="font-normal"
              ...
              <Field orientation="horizontal">
                <RadioGroupItem id="delivery-economy-594" value="economy" />
                <FieldContent>
                  <FieldLabel
                    className="font-normal"
      ...
      <CardContent>
        <FieldGroup>
          <Field orientation="horizontal">
            ...
            <FieldLabel className="font-normal" htmlFor="terms-y7h">
          ...
          <FieldSet>
            ...
            <FieldGroup data-slot="checkbox-group">
              <Field orientation="horizontal">
                ...
                <FieldLabel className="font-normal" htmlFor="pref-dark-rfv">
                  Dark mode
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="pref-compact-ti2" />
                <FieldLabel className="font-normal" htmlFor="pref-compact-ti2">
                  Compact view
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
          ...
          <FieldSet>
            ...
            <FieldGroup className="flex-row flex-wrap gap-3 *:data-[slot=field]:w-fit">
              <Field orientation="horizontal">
                ...
                <FieldLabel className="font-normal" htmlFor="javascript-4ee">
                  JavaScript
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="typescript-cdv" />
                <FieldLabel className="font-normal" htmlFor="typescript-cdv">
                  TypeScript
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="react-qhm" />
                <FieldLabel className="font-normal" htmlFor="react-qhm">
                  React
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="nodejs-ug1" />
                <FieldLabel className="font-normal" htmlFor="nodejs-ug1">
                  Node.js
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="python-azl" />
                <FieldLabel className="font-normal" htmlFor="python-azl">
                  Python
                </FieldLabel>
              </Field>
              <Field orientation="horizontal">
                <Checkbox id="database-br8" />
                <FieldLabel className="font-normal" htmlFor="database-br8">
                  Database
                </FieldLabel>
              </Field>
            </FieldGroup>
    ...
    <Card>
      ...
      <CardContent>
        <FieldGroup>
          ...
          <Field orientation="horizontal">
            <Switch defaultChecked id="auto-save-eux" />
            <FieldContent>
          ...
          <Field>
            ...
            <Field orientation="horizontal">
              <Switch defaultChecked id="profile-visible-zaq" />
              <FieldContent>
                <FieldLabel
                  className="font-normal"
            ...
            <Field orientation="horizontal">
              ...
              <FieldContent>
                <FieldLabel className="font-normal" htmlFor="show-email-x90">
                  Show email on profile
                </FieldLabel>
              </FieldContent>
            </Field>
            <Field orientation="horizontal">
              <Switch defaultChecked id="allow-indexing-d58" />
              <FieldContent>
                <FieldLabel
                  className="font-normal"
          ...
          <Field orientation="horizontal">
            <Switch disabled id="disabled-switch-4eu" />
            <FieldContent>
              <FieldLabel className="opacity-50" htmlFor="disabled-switch-4eu">
                Disabled Feature
              </FieldLabel>
              <FieldDescription>
        ...
        <FieldGroup>
          <Field>
            ...
            >
              ...
              <ToggleGroupItem className="flex-1" value="cards">
                Cards
              </ToggleGroupItem>
            </ToggleGroup>
          </Field>
          <Field>
            ...
            <ToggleGroup className="flex-wrap" type="single" variant="outline">
      ...
      <CardContent>
        <FieldGroup>
          <Field>
            ...
            <Input id="text-input-qmg" placeholder="Enter text" type="text" />
      ...
      <CardContent>
        <FieldGroup>
          ...
          <Field>
            ...
            <Input accept="image/*,.pdf" id="file-input-hmb" type="file" />
          ...
          <Field>
            ...
            <InputOTP id="otp-custom-hip" maxLength={6}>
              <InputOTPGroup className="gap-2">
                <InputOTPSlot className="rounded-md border" index={0} />
    ...
    <Card>
      ...
      <CardContent>
        <FieldGroup>
          ...
          <Field>
            <FieldLabel className="opacity-50" htmlFor="disabled-date-1vz">
              Event Date (Disabled)
            </FieldLabel>
            <Button
          ...
          <FieldSet>
            ...
            <FieldGroup>
              <FieldSet>
                ...
                <RadioGroup defaultValue="email">
                  <Field orientation="horizontal">
                    <RadioGroupItem id="contact-email-hxb" value="email" />
                    <FieldLabel
                      className="font-normal"
                  ...
                  <Field orientation="horizontal">
                    <RadioGroupItem id="contact-phone-7id" value="phone" />
                    <FieldLabel
                      className="font-normal"
                  ...
                  <Field orientation="horizontal">
                    ...
                    <FieldLabel className="font-normal" htmlFor="contact-sms">
                      SMS
                    </FieldLabel>
                  </Field>
                </RadioGroup>
              ...
              <FieldSet>
                ...
                <FieldGroup className="gap-3">
                  <Field orientation="horizontal">
                    <Checkbox defaultChecked id="updates-2sv" />
                    <FieldLabel className="font-normal" htmlFor="updates-2sv">
                      Product updates
                    </FieldLabel>
                  </Field>
                  <Field orientation="horizontal">
          ...
          <FieldSet>
            ...
            <FieldGroup>
              ...
              <Field orientation="horizontal">
                ...
                <Switch defaultChecked id="public-profile-bbt" />
              </Field>
              <Field orientation="horizontal">
                <FieldContent>
          ...
          <FieldSet>
            ...
            <FieldGroup>
              ...
              <Field orientation="horizontal">
                ...
                <FieldContent>
                  <FieldLabel className="font-normal" htmlFor="agree-terms-04d">
                    I agree to the terms and conditions
                  </FieldLabel>
                </FieldContent>
              </Field>
        ...
        <FieldGroup>
          ...
          <FieldGroup>
            <Field orientation="horizontal">
              ...
              <FieldContent>
                <FieldLabel className="font-normal" htmlFor="option1-ntl">
            ...
            <Field orientation="horizontal">
              ...
              <FieldContent>
                <FieldLabel className="font-normal" htmlFor="option2-n0m">
          ...
          <RadioGroup defaultValue="option1">
            <Field orientation="horizontal">
              <RadioGroupItem id="path1-pgt" value="option1" />
              <FieldLabel className="font-normal" htmlFor="path1-pgt">
                Option Path 1
              </FieldLabel>
            </Field>
            <Field orientation="horizontal">
              <RadioGroupItem id="path2-7pd" value="option2" />
              <FieldLabel className="font-normal" htmlFor="path2-7pd">
                Option Path 2
              </FieldLabel>
            </Field>
          </RadioGroup>
      ...
      <FieldSet>
        ...
        <FieldGroup>
          <Field orientation="horizontal">
            ...
            <Switch defaultChecked id="outline-demo-8h3-email-notif-vk0" />
          </Field>
          <FieldSeparator />
          <Field orientation="horizontal">
            <FieldContent>
            ...
            <Switch defaultChecked id="outline-demo-8h3-push-notif-5m7" />
          </Field>
          <FieldSeparator />
          <Field orientation="horizontal">
          ...
          <FieldSeparator />
          <Field orientation="horizontal">
            <Switch defaultChecked id="outline-demo-8h3-weekly-digest-xor" />
            <FieldContent>
          ...
          <FieldGroup>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field>
                ...
                <Input defaultValue="John" id="profileFirstName-h2r" />
              </Field>
              <Field>
                <FieldLabel htmlFor="profileLastName-cal">Last Name</FieldLabel>
                <Input defaultValue="Doe" id="profileLastName-cal" />
              </Field>
            </div>
        ...
        <form>
          <FieldGroup>
            ...
            <Field>
              ...
              <RadioGroup>
                <Field orientation="horizontal">
                  <RadioGroupItem id="daily-lrv" value="daily" />
                  <FieldLabel htmlFor="daily-lrv">Daily</FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <RadioGroupItem id="weekly-mga" value="weekly" />
                  <FieldLabel htmlFor="weekly-mga">Weekly</FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <RadioGroupItem id="monthly-7gl" value="monthly" />
                  <FieldLabel htmlFor="monthly-7gl">Monthly</FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <RadioGroupItem id="rarely-hlw" value="rarely" />
            ...
            <Field>
              ...
              <div className="grid w-full grid-cols-2 gap-2">
                <Field orientation="horizontal">
                  ...
                  <FieldLabel className="text-sm" htmlFor="dashboar d-epk">
                    Dashboard
                  </FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <Checkbox id="reports-jkm" />
                  <FieldLabel className="text-sm" htmlFor="reports-jkm">
                    Reports
                  </FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <Checkbox id="analytics-kwm" />
                  <FieldLabel className="text-sm" htmlFor="analytics-kwm">
                    Analytics
                  </FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <Checkbox id="integrations-euz" />
                  <FieldLabel className="text-sm" htmlFor="integrations-euz">
                    Integrations
                  </FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <Checkbox id="api-e2h" />
                  <FieldLabel className="text-sm" htmlFor="api-e2h">
                    API Access
                  </FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <Checkbox id="support-qq9" />
                  <FieldLabel className="text-sm" htmlFor="support-qq9">
                    Support
                  </FieldLabel>
                </Field>
              </div>
            ...
            <Field>
              ...
              <RadioGroup>
                ...
                <Field orientation="horizontal">
                  <RadioGroupItem id="satisfied-hn4" value="satisfied" />
                  <FieldLabel htmlFor="satisfied-hn4">Satisfied</FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <RadioGroupItem id="neutral-6az" value="neutral" />
                  <FieldLabel htmlFor="neutral-6az">Neutral</FieldLabel>
                </Field>
                <Field orientation="horizontal">
                  <RadioGroupItem id="dissatisfied-sy9" value="dissatisfied" />
              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <ToggleGroup
                    ...
                    variant="outline"
                  >
                    <ToggleGroupItem className="flex-1" value="remote">
                      Remote
                    </ToggleGroupItem>
                    <ToggleGroupItem className="flex-1" value="office">
                      Office
                    </ToggleGroupItem>
                    <ToggleGroupItem className="flex-1" value="hybrid">
                      Hybrid
                    </ToggleGroupItem>
                  </ToggleGroup>
                </Field>
            ...
            <FieldSet>
              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <Input accept=".pdf,.doc,.docx" id="resume-yyr" type="file" />
                  <FieldDescription>
                ...
                <Field>
                  ...
                  <RadioGroup defaultValue="yes">
                    <Field orientation="horizontal">
                      <RadioGroupItem id="ref-yes" value="yes" />
                      <FieldLabel className="font-normal" htmlFor="ref-yes">
                        Yes, upon request
                      </FieldLabel>
                    </Field>
                    <Field orientation="horizontal">
                      <RadioGroupItem id="ref-no-pqi" value="no" />
                      <FieldLabel className="font-normal" htmlFor="ref-no-pqi">
                        No
                      </FieldLabel>
                    </Field>
                  </RadioGroup>
            ...
            <FieldSet>
              ...
              <FieldGroup>
                ...
                <Field orientation="horizontal">
                  ...
                  <Switch defaultChecked id="notifications-rfq" />
                </Field>
                <FieldGroup>
                  <Field orientation="horizontal">
                  ...
                  <Field orientation="horizontal">
                    ...
                    <FieldLabel className="font-normal" htmlFor="accurate-vte">
            ...
            <FieldSet>
              ...
              <FieldGroup>
                <Field data-invalid>
                  ...
                  <Select>
                    <SelectTrigger aria-invalid id="position-invalid-1fv">
                      <SelectValue placeholder="Select a position" />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="frontend">
                ...
                <FieldSet>
                  ...
                  <FieldGroup className="grid grid-cols-3 gap-3">
                    <Field data-invalid orientation="horizontal">
                      <Checkbox aria-invalid id="skill-ts-invalid-khi" />
                      <FieldLabel
                        className="font-normal"
                    ...
                    <Field data-invalid orientation="horizontal">
                      <Checkbox aria-invalid id="skill-react-invalid-oxj" />
                      <FieldLabel
                        className="font-normal"
                    ...
                    <Field data-invalid orientation="horizontal">
                      <Checkbox aria-invalid id="skill-node-invalid-y18" />
                      <FieldLabel
                        className="font-normal"
                    ...
                    <Field data-invalid orientation="horizontal">
                      <Checkbox aria-invalid id="skill-python-invalid-3jp" />
                      <FieldLabel
                        className="font-normal"
                    ...
                    <Field data-invalid orientation="horizontal">
                      <Checkbox aria-invalid id="skill-docker-invalid-5b0" />
                      <FieldLabel
                        className="font-normal"
          ...
          <FieldSet>
            ...
            <FieldGroup>
              ...
              <Field orientation="horizontal">
                ...
                <Slider defaultValue={[50]} id="horizontal-volume" max={100} />
              </Field>
              <Field orientation="horizontal">
                <FieldContent>
                ...
                <Switch defaultChecked id="horizontal-auto-save" />
              </Field>
            </FieldGroup>
          </FieldSet>
